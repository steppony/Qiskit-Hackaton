...
tangible to high school students. Solutions to all the exercises are provided in the [solutions](https://github.com/steppony/Qiskit-Hackaton/tree/main/Exercises/Solutions) folder.
